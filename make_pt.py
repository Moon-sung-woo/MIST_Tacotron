...
def parse_args(parser):
    ...
    parser.add_argument('--wav-files', type=str, default='filelists/train_file_list4.txt',
                        help='Path to filelist with audio paths and text')
    parser.add_argument('--mel-files', type=str, default='filelists/train_mel_file_list.txt',
